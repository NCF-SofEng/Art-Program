...
public class ArtProgramMenu extends ProcessingWindow {
    private Map<String, Double> parameters;
    private Map<String, ArtProgramMenu.button> updateButtons;
     ...
     * @param parameters
     */
    public ArtProgramMenu(int width, int height, String title, Map<String, Double> parameters) {
        super(width, height, title);

        this.parameters = parameters;
        updateButtons = new LinkedHashMap<String, ArtProgramMenu.button>();
    ...
    public void draw() {
        ...
        for (String parameter : parameterNames) {
            ...
            updateButtons.put(parameter,  new ArtProgramMenu.button(parameter, buttonX, centerY, buttonHeight));
